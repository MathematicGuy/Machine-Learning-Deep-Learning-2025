...
\textbf{Phần 1: Từ Linear Regression đến Logistic Regression}  \\
...
\textbf{Phần 2: Mở rộng - Logistic Regression khi đưa về dạng Vector–Matrix}  \\
...
\textbf{Phần 3: Tại sao BCE là hàm Convex - Phân tích bằng Hessian Matrix}  \\
...
\input{lg_loss_from_stats.tex} % Logarithm and Log-Likelihood Function
