...
\begin{summarybox}
    Buổi học số 7 (Chủ Nhật, 20/07/2025) .... thành 8 nội dung chính:
    \begin{itemize}
        \item \textbf{Phần 1: Motivation: Tại sao cần NumPy?}
        \item \textbf{Phần 2: Giới thiệu NumPy}
        \item \textbf{Phần 3: CRUD trên Array}
        \item \textbf{Phần 4: Array Transformations}
        \item \textbf{Phần 5: View vs Copy – Hiểu đúng để tránh bug}
        \item \textbf{Phần 6: Vectorization \& Broadcasting}
        \item \textbf{Phần 7: AI Applications}
        \item \textbf{Phần 8: Mở rộng}
    \end{itemize}
\end{summarybox}

% Your subsequent content would go here.
% \newpage
